        ...
        <div className="container mx-auto">
          <div className="justify-content-center gap-5 row py-5">
            ...
            <figure className="shop__main-img d-flex align-items-center justify-content-center">
              <img src={item.images[imgIndex]} className="shop__img  " alt="" />
            </figure>
            <div className="d-flex gap-2 justify-content-center mt-4">
                {item.images?.map((img, i) => (
                    <figure className="d-flex align-items-center  border rounded p-1" onMouseEnter={()=> setImgIndex(i)}
                    style={{boxShadow: i==imgIndex? "0px 0px 5px 0px #60a5fa": "none"}}>
                        <img className="shop__img shop__mini-img d-inline-block" src={img} alt="" />
                    </figure>
                ))}
            </div>
            </div>
            ...
            <div className="col-6 px-4 d-flex flex-column justify-content-around ">
              ...
              <button className="btn btn-primary px-4 my-2">Add to Cart</button>
                </div>
